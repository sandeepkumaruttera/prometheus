...
wget https://github.com/prometheus/alertmanager/releases/download/v0.28.1/alertmanager-0.28.1.linux-amd64.tar.gz &>>$LOGFILE
VALIDATE $? "Downloading alert manager" 

tar -xf alertmanager-0.28.1.linux-amd64.tar.gz &>>$LOGFILE
VALIDATE $? "Extracted alert manager"

mv alertmanager-0.28.1.linux-amd64 alertmanager &>>$LOGFILE

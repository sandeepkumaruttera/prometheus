...
wget https://github.com/prometheus/prometheus/releases/download/v3.3.0/prometheus-3.3.0.linux-amd64.tar.gz &>>$LOGFILE

tar -xf prometheus-3.3.0.linux-amd64.tar.gz  &>>$LOGFILE
VALIDATE $? "extracted prometheus"

mv prometheus-3.3.0.linux-amd64 prometheus &>>$LOGFILE
